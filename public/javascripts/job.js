var obj_NgApp = angular.module('app_job', ['ngRoute', 'ui.bootstrap']);
...
obj_NgApp.controller('ctr_jobDtl', ['$scope', '$routeParams', '$http', '$document', '$location', function ($scope, $routeParams, $http, $document, $location, sharedDObj) {
...
obj_NgApp.controller('ctr_job', function ($scope, $http, sharedDObj, $document, $window, $location, sharedDObj) {
