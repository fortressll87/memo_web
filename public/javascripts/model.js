var obj_NgApp = angular.module('app_model', ['ngRoute', 'ui.bootstrap']);

obj_NgApp.config(['$routeProvider', function($routeProvider) {
    $routeProvider.
        when('/list', {
          templateUrl: 'list.html',
          controller: 'ctr_model'
        }).
        when('/detail/:idx', {
          templateUrl: 'detail.html',
          controller: 'ctr_modelDtl'
        }).
        otherwise({
          redirectTo: '/list'
        });
...
obj_NgApp.controller('ctr_modelDtl', ['$scope', '$routeParams', '$http', '$document', '$location', function ($scope, $routeParams, $http, $document, $location, sharedDObj) {
...
obj_NgApp.controller('ctr_model', function ($scope, $http, sharedDObj, $document, $window, $location, sharedDObj) {
    ...
    function searchResultHandler(returnData) {
        $scope.test_cols = returnData.resultDo;
